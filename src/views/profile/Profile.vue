    ...
    data: function () {
      return {
        orderList: [
          ...
          {icon: '#icon-jifenshangcheng', iconColor: '#fc7b53', info: '积分商城'},
          {icon: '#icon-31huiyuanqia', iconColor: '#ffc636', info: '会员卡'},
        ],
        serviceList: [
          {icon: '#icon-wodegouwuche', iconColor: '#ff8198', info: '我的购物车'},
